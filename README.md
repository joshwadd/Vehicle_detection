...
| `Code/vehicle_detection.ipynb`   | Ipython notebook used to train a linear SVM on a training data set of vehicle and non vehicle im|

<!--stackedit_data:
eyJoaXN0b3J5IjpbNjY4MDc0MDcxXX0=
-->