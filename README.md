...
Experiments on the parameters of the parameters for the HOG extraction were performed to find the set that maximised the classification accuracy
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTgzOTc4ODZdfQ==
-->