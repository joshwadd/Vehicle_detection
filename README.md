...
The linear support vector machine classifier was trained on features extracted from a **64 x 64** pixel region. Searching windows regions at scales differing from this then will require resizing back to this size. Searching the 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk2NzM0OTQ5OF19
-->