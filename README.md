...
Sklearn toolkit was used to train the linear SVM and the input data was pre-processed to have zero mean and unit variance. Cross validation was done to find the optimal hyperparameters X
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA4MTA0ODA2MF19
-->