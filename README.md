...
The pipeline for performing a sliding windows search at various scales and locations in an image is implemented by the `VehicleDection` class in `vehicle_detection.py`.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwOTEyMDIyMTNdfQ==
-->