...
The image data is originally represented in RGB colour space. A series of colour space transforms were explored to in order to find a space in which the pixels associated with cars lie clustered together seperated from pixels assoai
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNTc2NjE2Ml19
-->