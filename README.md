...
Spatial information of the image is added to the feature space by taking the original image, resizing it to a smaller resolution (removing the higher frequency informati
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzQ4MzM2NzkzXX0=
-->