...
The key component to the object detection pipeline is a robust image classifier, capable of detecting if a given image contains 



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NTI0NTIxN119
-->