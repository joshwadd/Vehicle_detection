...
The class implements the feature extraction in an efficient method by only computing the expensive hog features once upon initialisation. The class abstracts all implementation detail however and the features can be extracted from any given region w
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NjIxOTUwNjFdfQ==
-->