...
Such a transform results in a returned tensor of size **7x7x2x2x10**. This hog transform is used on each channel of the colour image resulting in a 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ4MTExMTYyNF19
-->