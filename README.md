...
The class implements the feature extraction in an efficient method by only computing the expensive hog features once on initialisation. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU1MDQwNjg1MF19
-->