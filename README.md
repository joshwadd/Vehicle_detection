...
Applying the heatmap and then thresholding to the image below leaves two distinct heat signifture assoauted which each of the vehicles 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA1OTM2NDM3N119
-->