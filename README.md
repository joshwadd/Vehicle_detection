...
Sklearn toolkit was used to train the linear SVM and the input data was pre-processed to have zero mean and unit variance. Cross validation was done to find the optimal hyperparameters C
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NzMzOTU0NV19
-->