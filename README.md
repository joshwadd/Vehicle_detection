...
Applying the heatmap and then thresholding to the image below leaves two distinct heat signifture assoauted which each of the 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA3NTI2NjQzNF19
-->