...
The class implements the feature extraction in an efficient method by only computing the expensive hog features once upon initialisation. The class abstracts all implementation detail however and the features can be extracted using the followin
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzIwNDc3MTBdfQ==
-->