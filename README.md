...
def add_heat(self, heatmap, windows, threshold = 15):
        ...
        return heatmap
```
The heat map can then be thresholded to a desired tolerance. This has the desired effect of removing any unwanted false positive detections and a
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU1MTY3NDU0XX0=
-->