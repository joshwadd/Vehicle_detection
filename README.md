...
Deciding on the best features to extract from the image for robust classification was done with a combination of trail an error and intuition. 




<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgzODM0NTYwNl19
-->