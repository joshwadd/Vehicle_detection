...
The image data is originally represented in RGB colour space. A series of colour space transforms were explored to in order to find a space in which
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzkxNDI2NDE0XX0=
-->