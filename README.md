...
Deciding on the best features to extract from the image for robust classification was done with a combination of trail and error and intuition. 




<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU1NzY3MzU5MF19
-->