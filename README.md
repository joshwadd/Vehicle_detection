...
Applying the heatmap and then thresholding to the image below leaves two distinct heat signifture assoauted which each of the vehicles in the iamge 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUxNjIzOTIwNF19
-->