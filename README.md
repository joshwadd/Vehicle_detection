...
Spatial information of the image is added to the feature space by taking the original image, resizing it to a smaller resolut
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NDQ3MDU3NzddfQ==
-->